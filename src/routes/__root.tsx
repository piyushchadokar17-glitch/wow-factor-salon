...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Premium unisex salon offering hair styling, bridal & party makeup, facials, spa and more. Enhancing Beauty, Inspiring Confidence." },
      { name: "author", content: "The Wow Factor" },
